...
{CGPA -- 4.00/4.00}{Advisor: Prof. Daniel Segrè}

\cventry
{2011--2016}
{B.Tech (Honors) and M.Tech (Dual Degree) in Biotechnology}
{Indian Institute of Technology -- Madras}{Chennai, India}
{CGPA -- 9.23/10.00}{Advisor: Prof. Karthik Raman}

\section{Experience}
\cvitemwithcomment{Graduate Student Researcher}{Boston University}{2016 -- Present}
\cvlistitem{Developed ReLearn, a reinforcement learning framework for optimal control of microbial communities in bioreactors}
\cvlistitem{Developed MiCoNE, a 16S sequencing data analysis pipeline for the inference of co-occurrence networks}
\cvlistitem{Developed a pipeline to estimate binding affinities of microbial metabolites with the AHR}
\cvlistitem{Formulated a mathematical model of the AHR regulatory pathway to study its implications in cancer progression}
\cvlistitem{Assisted in the development of MIND, a database and web interface for the visualization and analysis of microbial interaction networks}
\cvlistitem{Assisted in the analysis of metagenomics data from the gut microbiome of ultra centenarians and inference of co-occurrence networks}
\cvlistitem{Assisted in the development of pipeliner, a nextflow pipeline for the analysis of bulk RNA sequencing data}

\cvitemwithcomment{Software developer}{Open-source software}{2018 -- Present}
\cvlistitem{Developed pyssa, a Python package for performing stochastic simulations with a Cython backend}
\cvlistitem{Developed a dashboard for calculating daily carbon footprint using the Julia language}
\cvlistitem{Developed mace, a web application to calculate total carbon emissions of sourcing recipe ingredients}
...
\cvitem{Web and Database}{React, Typescript, Flask, Django, PostgreSQL, MySQL}
\cvitem{Cloud}{Docker, Singularity, AWS, Linode}
\cvitem{Other}{Linux, git, C, C++, HTML/CSS, \LaTeX}


\section{Selected posters and talks}

\cvitem{}{(*presenter)}
\cvlistitem{*Dileep Kishore, Pankaj Mehta, Daniel Segrè. \emph{Using deep-RL to control bioreactors: The ReLearn framework}. Talk. Kilachand fellowship presentation sponsored by the Multicelluar Design Program (May 2022).}
...
\section{Awards}
\cvitemwithcomment{Academic Fellowship}{Kilachand fellowship sponsored by the multicelluar design program}{2021}
