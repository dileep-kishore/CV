...
\cvlistitem{Created MiCoNE, a 16S sequencing data analysis pipeline for the inference of co-occurrence networks}
\cvlistitem{Constructed a pipeline to estimate binding affinities of microbial metabolites with the AHR}
...
\cvlistitem{Advanced the development of pipeliner, a nextflow pipeline for the analysis of bulk RNA sequencing data}

\cvitemwithcomment{Software developer}{Open-source software}{2018 -- Present}
\cvlistitem{Developed cayenne, a Python package for performing stochastic simulations with a Cython backend}
